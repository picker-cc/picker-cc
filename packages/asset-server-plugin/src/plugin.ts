 ...
 * ## Installation
 *
 * `yarn add \@Picker/asset-server-plugin`
 *
 * or
 *
 * `npm install \@Picker/asset-server-plugin`
 *
 * @example
 * ```ts
 * import { AssetServerPlugin } from '\@Picker/asset-server-plugin';
 *
 ...
 * ### Focal point
 *
 * When cropping an image (`mode=crop`), Picker will attempt to keep the most "interesting" area of the image in the cropped frame. It does this
...
export class AssetServerPlugin implements OnPickerBootstrap, OnPickerClose {
    ...
    /**
     * Sends the file requested to the browser.
     */
