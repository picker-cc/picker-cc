...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.create = function (createUserDto) {
        return "This action adds a new user with dto ".concat(JSON.stringify(createUserDto));
    };
    ...
    UsersService.prototype.update = function (id, updateUserDto) {
        return "This action updates a #".concat(id, " user with dto ").concat(JSON.stringify(updateUserDto));
    };
