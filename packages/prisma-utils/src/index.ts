// this file generates the GraphQL filters types for most of our fields.
...
(async () => {
    ...
    for (const provider of providers) {
        ...
        const rootTypes = scalarTypes.flatMap((scalar: string) => {
            ...
            if (scalar === 'SomeEnum') {
                // the filters types have to be generic over the enum so it's just easier to write it out manually
...
function replaceNestedNotFilterTypes(
    ...
    // we want to not replace the nested filters for strings because we don't replace it on postgresql
