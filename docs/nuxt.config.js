    ...
    */
    head: {
        ...
        meta: [
            ...
            { hid: `og:site_name`, property: 'og:site_name', content: 'Picker' },
            { hid: `og:type`, property: 'og:type', content: 'website' },
            { hid: `og:image`, property: 'og:image', content: `https://picker.cc/images/pages/index.og.jpg` }
        ],
        link: [
